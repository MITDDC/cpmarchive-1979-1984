...
WRDLOP:	MOV	A,M	;GET BYTE FROM READ BUFFER
	...
	JZ	WRCRLF	;YES GO WRITE IT AND A LF
	CPI	LF	;LINE FEED ?
...
WRLF:	LDA	LSTCHR	;GET LAST CHARACTER
	...
	LHLD	OCOUNT	;GET ORPHAN LF COUNT
	INX	H	;ADD ONE
...
OCOUNT:	DW	0	;ORPHAN LINE FEED COUNTER
