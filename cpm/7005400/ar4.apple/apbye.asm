...
;*************************
;
;THIS PROGRAM DOES NOT APPEAR TO
;WORK WITH ALL APPLES AT THIS 
;POINT.. IF YOU ARE ABLE TO DE-
;BUG IT FURTHER FOR YOUR SYSTEM
;PLEASE NOTIFY ME OF YOUR MOD-
;IFICATIONS:
;
;        DAVID MORITZ
;         2228 N.SAWYER
...
;
;
;01/26/81 CHANGED EQUATES, I/O
;PORTS AND FLAGS FOR MMII
;
;   CHANGED ALL IN/OUT COMMANDS
;TO LDA/STA.   (DM)
;
...
LF	EQU	0AH
;
MAX$DRIVE	EQU	1	;HIGHEST SUPPORTED DRIVE (0=A, 1=B, etc)
...
FASTCLK	EQU	FALSE	;TRUE IF 4MHZ SYSTEM CLOCK
CPM2	EQU	TRUE	;TRUE FOR CP/M VERSION 2.x
WBCMND	EQU	FALSE	;TRUE TO USE WARM BOOT COMMAND
WBUSER	EQU	3	;USER # FOR WARM BOOT COMMAND (MUST BE 0 LDA 1.4 CP/M)
...
P0NORM  EQU     15H           ;8 BITS NO PARITY 1 STOP BIT
...
ANSWR1	EQU	$+OFFSET
	...
	LDA	CONDATA	;CLEAR LOCAL KBD PORT
...
CARCK	EQU	$+OFFSET
	...
	MVI	E,150
CARCK1	EQU	$+OFFSET
	LDA	RPORT1	;LOOK AT STATUS
	ANI	P2CTS	;GET CARRIER DETECT BIT
        XRI     04H     ;NEGATIVE LOGIC
