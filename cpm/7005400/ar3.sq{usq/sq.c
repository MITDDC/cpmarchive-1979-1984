...
char *argv[];
{
	...
	printf("File squeezer version %s by\n\tRichard Greenlaw\n\t251 Colony Ct.\n\tGahanna, Ohio 43230\n", VERSION);
	printf("Accepts redirection and pipes.\nOmit other parameters for help and prompt\n");
	...
	if(argc < 2) {
		printf("Parameters are from command line or one-at-a-time from standard input and are output drives and input file names. Empty to quit.\n");
		do {
			putchar('\n');
			putchar('*');
			for(i = 0; i < 16; ++i) {
