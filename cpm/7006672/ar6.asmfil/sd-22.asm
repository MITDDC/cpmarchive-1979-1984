...
;
	...
	CPI	'S'-40H	;CTL-S?
	JNZ	NOBRK	;NO, CONTINUE
	CALL	CINPUT	;YES, WAIT FOR ANOTHER CHAR.
	CPI	'C'-40H	;MIGHT BE CTL-C
	JZ	EXIT	;EXIT IF CTL-C, ELSE FALL THRU AND CONTINUE
;
NOBRK:	LHLD	NEXTT
	MVI	A,11
...
TYPE:	PUSH	B
	...
	ENDIF		;DIRCON
;
	IF	NOT DIRCON ;USE BDOS CONSOLE OUTPUT
TYPE:	PUSH	B
	PUSH	D
	PUSH	H
	MOV	E,A
	MVI	C,WRCHR	;CHAR TO CONSOLE
	CALL	BDOS
	POP	H
	POP	D
	POP	B
...
;
	IF	NOT WIDE
	LXI	D,TOTMS1+1 ;SKIP PRINTING DRIVE NAME
	ENDIF
;
	MVI	C,PRINT
	CALL	BDOS
