	TITLE	'BYE V7.2 OF 10/14/81'
	PAGE	44
;
;		BYE V7.2 (revised 10/14/81)
...
MAXUSR	EQU	6	;SET TO 0 FOR CP/M 1.4
MAXDRV	EQU	2	;HIGHEST DRIVE SUPPORTED
FASTCLK EQU	TRUE 	;SET TRUE FOR 4 MHZ CLOCK
TIMEOUT EQU	TRUE	;WANT AUTO LOG-OFF FOR SLEEPY CALLERS?
TOVALUE EQU	5	;THIS IS 5 MINUTES TO AUTO LOGOUT
...
;
;Program version number message. Leave it in low
;RAM, since it will be printed out before BYE does
;anything else, or not at all.
;
VMSG:	DB	'BYE version 7.2 of 10/14/81',CR,LF,'$'
;
;
...
;defined to consist of only this jump, with PRNLOG
;beginning immediately after the jump. By doing this,
...
PRNREL	EQU	$+OFFSET
	...
	JNZ	0000H	;IF NOT "R", WARM BOOT CP/M
;
PRNRES	EQU	$+OFFSET
	MVI	C,PRINTF
	LXI	D,RS2MSG
