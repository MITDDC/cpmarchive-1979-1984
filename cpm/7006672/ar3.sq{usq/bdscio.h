...
#define	MSTAT	0xC0	/* Modem status port	*/

#define MDATA	0xC1	/* Modem data port	*/

#define MIMASK	0x02	/* Modem input data ready mask	*/

#define MOMASK	0x01	/* Modem ready to send a character mask	*/
