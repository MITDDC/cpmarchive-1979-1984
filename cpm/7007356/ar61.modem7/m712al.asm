; M712AL.ASM -- ALTOS SERIES 5 overlay file for MDM712.  07/27/83 
;
; You will want to look this file over carefully. There are a number of
; options that you can use to configure the program to suit your taste.
; This file adapts the ALTOS SERIES 5 computers to MDM712.
;
...
;		NEXT  PC
;		4300 0100
;               -IM712AL.HEX		(note the "I" command)
;               -R                      ("R" loads in the .HEX file)
;		NEXT  PC
;		4300 0000
;		-G0			(return to CP/M)
;		A>SAVE 66 MDM7121.COM	(now have a modified .COM file)
;
; =   =   =   =   =   =   =   =   =   =   =   =   =   =   =   =   =   =
;
...
;
;
LOGON:          DB      'This is an Altos Series 5 computer',CR,LF,0
;.....
;
;
