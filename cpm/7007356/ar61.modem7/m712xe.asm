...
; M712XE.ASM -- XEROX 820 and 820-II overlay file for MDM712.  07/27/83
;
; You will want to look this file over carefully. There are a number of
; options that you can use to configure the program to suit your taste.
; This file adapts the XEROX 820 and 820-II computers to MDM712.
;
...
;		NEXT  PC
;		4300 0100
;		-IM712XE.HEX		(note the "I" command)
...
SYSVER:		CALL	JMP$ILPRT	;				1A7H
		DB	'Version for XEROX 820 II serial port 04H'
		DB	CR,LF,0
		RET
;.....
;
...
;
;
LOGON:		DB	'This is a Xerox 820 computer',CR,LF,0
;.....
;
;
...
;
;	
; XEROX 820 II initialization -- sets CTC timer 00H for send and receive
; baudrate.
;
