...
; M712DP.ASM -- Datapoint 1560 overlay file for MDM712.  07/27/83
;
...
; shown below.
;
; Use the MDM712 "SET" command to change the baudrate when desired.  It
...
;		NEXT  PC
;		4300 0100
;		-IM712DP.HEX		(note the "I" command)
...
;
;
PORT:		EQU	028H		;Datapoint 1560 Modem Data Port
...
CLOCK:		DB	37	;clock speed in MHz x10, 25.5 MHz max.	106H
...
CLRSCRN:	CALL	JMP$ILPRT	;				19EH
		DB	ESC,3AH,0,0,0	;				1A1H
		RET			;				1A6H
;
;
SYSVER:		CALL	JMP$ILPRT	;				1A7H
		DB	'Version for Datapoint 1560 modem port 28H'	
		DB	CR,LF,0
		RET
;.....
;
...
;
;
LOGON:	  DB	'This is a Datapoint 1560 computer',CR,LF,0
;
;=======================================================================
;
...
;
;
; Datapoint 1560 initialization -- sets CTC timers 20H and 1AH for
; baudrate in/out.
;
INITMOD:  MVI	A,1		;DEFAULT TRANSFER TIME TO 300 BAUD
	  ...
	  OUT	1AH
;
INITMOD1: MVI	A,20H		;DEFAULT TO 300 BAUD
	  OUT	20H
	  OUT	1AH
	  RET
;.....
...
SETUPR:	  LXI	D,BAUDBUF	;POINT TO NEW INPUT BUFFER
	  CALL	JMP$ILPRT
	  DB	'Input Baud Rate (300, 450, 1200, 9600): ',0
	  CALL	JMP$INBUF
	  LXI	D,BAUDBUF+2
...
BD450:	  DW	0015H		;9600/450  CONVERTED TO HEX VALUE
